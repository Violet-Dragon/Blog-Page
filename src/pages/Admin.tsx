...
import { saveBlogPost, getAllBlogPosts, deleteBlogPost, type BlogPost } from "@/lib/blogStorage";
import { useNavigate } from "react-router-dom";
import { 
  Eye, Save, Send, Sparkles, ArrowLeft, Bold, Italic, List, 
  Link2, Image as ImageIcon, Heading1, Heading2,
  AlignLeft, AlignCenter, AlignRight, AlignJustify,
  Underline, Type, Palette, Globe, 
  PenSquare, FileText, Inbox, Trash2, Edit
} from "lucide-react";
...
const handleEditPost = (post: BlogPost) => {
  ...
  <Select value={category} onValueChange={(value: any) => setCategory(value)}></Select>
  </div> */}
          <div>
            <Button
              variant="ghost"
            ...
            <p className="text-muted-foreground mt-2">Create amazing space content</p>
          </div>
